...
///
///     for (auto solution : nld::arc_length(nld::equilibrium(problem), x, t,
///     nld::solution()) {
///         ///< Do something with solution, e.g. dump to file, or collect into
///         some types and make plot
///     }
/// }
/// @endcode
...
/// continuation.
/// @details This version of function will pass tangential as unit vector with
/// N-1 zeros and last element equal to one.
/// @param function Parametric function which we want to continue.
...
/// @brief Solves continuation problem for nonlinear function using arc length
/// continuation.
/// @details This version of function will evaluate initial guess by itself.
/// Only dimension of problem is required for algorithm, since size is unknown
/// from nld types.
/// @param function Parametric function which we want to continue.
/// @param size The size of nonlinear problem.
/// @param parameters Continuation parameters.
