...
struct tensor_size<tensor_mul<L, R>> final {
    constexpr static std::size_t size =
        tensor_size<std::remove_reference_t<L>>::size +
        tensor_size<std::remove_reference_t<R>>::size;
};

/// @brief The meta function to determinate size of test function expression
/// tensor.
...
/// @brief The meta function to determinate size of weighted test function
/// expression tensor.
...
/// @brief The meta function to determinate size of derivative expression
/// tensor.
/// @details It is e product of underlying dimenstions.
template <typename E, typename W>
struct tensor_size<derivative<E, W>> final {
    constexpr static std::size_t size =
        tensor_size<std::remove_reference_t<E>>::size;
};
...
/// @brief The meta function to determinate size of variable integral expression
/// tensor.
/// @details It is e product of underlying dimenstions.
template <typename E, typename I, typename D, typename O>
struct tensor_size<variable_integral<E, I, D, O>> final {
    constexpr static std::size_t size =
        tensor_size<std::remove_reference_t<E>>::size;
};
} // namespace nld
