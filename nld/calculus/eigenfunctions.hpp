...
struct eigenfunctions final {
    ...
    explicit eigenfunctions(T test_functions, nld::matrix_xd&& eigenvectors, nld::index size) : 
        test_functions(test_functions), eigenvectors(std::move(eigenvectors)), size(size) {
